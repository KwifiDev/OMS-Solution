...
namespace OMS.UI.APIs.Services.Tables
{
    public class DebtService : GenericApiService<DebtDto, DebtModel>, IDebtService
    {
        ...
        public DebtService(IHttpClientFactory httpClientFactory, IMapper mapper, ILogService logService)
            : base(httpClientFactory.CreateClient("ApiClient"), mapper, ApiEndpoints.Debts, logService)
        {
        }
