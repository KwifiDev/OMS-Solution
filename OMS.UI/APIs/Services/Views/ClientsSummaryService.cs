...
namespace OMS.UI.APIs.Services.Views
{
    ...
    {
        public ClientsSummaryService(IHttpClientFactory httpClientFactory, IMapper mapper)
                           : base(httpClientFactory.CreateClient("ApiClient"), mapper, ApiEndpoints.ClientsSummary)
        {
        }
    }
}
