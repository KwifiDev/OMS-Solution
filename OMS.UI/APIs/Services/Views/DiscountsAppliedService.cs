...
namespace OMS.UI.APIs.Services.Views
{
    public class DiscountsAppliedService : GenericViewApiService<DiscountsAppliedDto, DiscountsAppliedModel>, IDiscountsAppliedService
    {
        ...
        public DiscountsAppliedService(IHttpClientFactory httpClientFactory, IMapper mapper, ILogService logService)
                                       : base(httpClientFactory.CreateClient("ApiClient"), mapper, ApiEndpoints.DiscountsApplied, logService)
        {
        }
