...
namespace OMS.UI.APIs.Services.Views
{
    ...
    {
        public PersonDetailService(IHttpClientFactory httpClientFactory, IMapper mapper)
                           : base(httpClientFactory.CreateClient("ApiClient"), mapper, ApiEndpoints.PeopleDetail)
        {
        }
    }
}
