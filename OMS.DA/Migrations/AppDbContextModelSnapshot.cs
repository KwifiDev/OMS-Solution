...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OMS_DA.Entities.Account", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.AccountBalancesTransaction", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.Branch", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.BranchOperationalMetric", b =>
                {
                    b.Property<string>("Address")
                        .IsRequired()
                        .HasMaxLength(100)
            ...
            modelBuilder.Entity("OMS_DA.Entities.Client", b =>
                {
                    b.Property<int>("ClientId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OMS_DA.Entities.ClientDetail", b =>
                {
                    b.Property<int>("ClientId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OMS_DA.Entities.ClientsByType", b =>
                {
                    b.Property<string>("ClientType")
                        .IsRequired()
                        .HasMaxLength(8)
            ...
            modelBuilder.Entity("OMS_DA.Entities.Debt", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.DebtsByStatus", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.DebtsSummary", b =>
                {
                    b.Property<string>("ClientName")
                        .IsRequired()
                        .HasMaxLength(41)
            ...
            modelBuilder.Entity("OMS_DA.Entities.Discount", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.DiscountsApplied", b =>
                {
                    b.Property<string>("ClientType")
                        .IsRequired()
                        .HasMaxLength(8)
            ...
            modelBuilder.Entity("OMS_DA.Entities.MonthlyFinancialSummary", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.Payment", b =>
                {
                    b.Property<int>("PaymentId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OMS_DA.Entities.PaymentsSummary", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.PermissionsConfig", b =>
                {
                    ...
                    b.ToTable("PermissionsConfig", (string)null);
                });

            modelBuilder.Entity("OMS_DA.Entities.Person", b =>
                {
                    b.Property<int>("PersonId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OMS_DA.Entities.Revenue", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.Sale", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.SalesSummary", b =>
                {
                    b.Property<string>("ClientName")
                        .IsRequired()
                        .HasMaxLength(41)
            ...
            modelBuilder.Entity("OMS_DA.Entities.Service", b =>
                {
                    b.Property<int>("ServiceId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OMS_DA.Entities.Transaction", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.TransactionsByType", b =>
                {
                    b.Property<string>("TotalAmount")
                        .HasMaxLength(34)
                        .IsUnicode(false)
            ...
            modelBuilder.Entity("OMS_DA.Entities.TransactionsSummary", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.UserAccount", b =>
                {
                    b.Property<int>("AccountId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("OMS_DA.Entities.UserDetail", b =>
                {
            ...
            modelBuilder.Entity("OMS_DA.Entities.Account", b =>
                {
                    b.HasOne("OMS_DA.Entities.Client", "Client")
                        .WithOne("Account")
                        .HasForeignKey("OMS_DA.Entities.Account", "ClientId")
                        .IsRequired()
            ...
            modelBuilder.Entity("OMS_DA.Entities.Client", b =>
                {
                    b.HasOne("OMS_DA.Entities.Person", "Person")
                        .WithOne("Client")
                        .HasForeignKey("OMS_DA.Entities.Client", "PersonId")
                        .IsRequired()
            ...
            modelBuilder.Entity("OMS_DA.Entities.Debt", b =>
                {
                    ...
                    b.HasOne("OMS_DA.Entities.User", "CreatedByUser")
                        .WithMany("Debts")
                        .HasForeignKey("CreatedByUserId")
                        .IsRequired()
                        .HasConstraintName("debts_createdbyuserid_foreign");

                    b.HasOne("OMS_DA.Entities.Payment", "Payment")
                        .WithMany("Debts")
                        .HasForeignKey("PaymentId")
                        .HasConstraintName("debts_paymentid_foreign");

                    b.HasOne("OMS_DA.Entities.Service", "Service")
                        .WithMany("Debts")
            ...
            modelBuilder.Entity("OMS_DA.Entities.Payment", b =>
                {
                    b.HasOne("OMS_DA.Entities.Account", "Account")
                        .WithMany("Payments")
            ...
            modelBuilder.Entity("OMS_DA.Entities.User", b =>
                {
                    b.HasOne("OMS_DA.Entities.Branch", "Branch")
                        .WithMany("Users")
                    ...
                    b.HasOne("OMS_DA.Entities.Person", "Person")
                        .WithOne("User")
                        .HasForeignKey("OMS_DA.Entities.User", "PersonId")
                        .IsRequired()
