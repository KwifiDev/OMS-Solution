...
{
    public class BranchOperationalMetricRepository : GenericViewRepository<BranchOperationalMetric>, IGenericViewRepository<BranchOperationalMetric>, IBranchOperationalMetricRepository
    {
